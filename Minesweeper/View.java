...
public class View extends JFrame{
    ...
    public View(Controller controller, Cell[][] cells){
        ...
        setPreferredSize(new Dimension(Cell.SIZE*Model.CELLS_PER_ROW+10, Cell.SIZE*Model.CELLS_PER_ROW+120));
        setSize(new Dimension(Cell.SIZE*Model.CELLS_PER_ROW+10, Cell.SIZE*Model.CELLS_PER_ROW+120));
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setLayout(new FlowLayout(FlowLayout.CENTER, 1, 1));
        JPanel pnlInfo = new JPanel();
        pnlInfo.setLayout(new FlowLayout(FlowLayout.CENTER, 1, 1));
        pnlInfo.setPreferredSize(new Dimension(getWidth(), 70));
